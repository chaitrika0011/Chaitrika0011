...
- 💻 Improved application implementation skills
...
- 💡 Developed structured problem-solving skills

### 🏢 Prodigy Info Tech

**July 2025 – September 2025**

- 💻 Worked on technical implementation tasks
- ✅ Performed validation-related tasks
- 🤝 Collaborated with teams
- ⚙️ Contributed to improving application functionality
...
Application Development
Learning Modern Technologies
🐙 "GitHub" (https://github.com/chaitrika0011)
